...
public class LevelView extends View {
    ...
    public LevelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.cl_LevelLayout);
        thumb = drawableToBitmap(array.getDrawable(R.styleable.cl_LevelLayout_cl_thumb));
        thumbWidth = array.getDimension(R.styleable.cl_LevelLayout_cl_thumbWidth, 0);
        thumbHeight = array.getDimension(R.styleable.cl_LevelLayout_cl_thumbHeight, 0);
        stepCount = array.getInteger(R.styleable.cl_LevelLayout_cl_stepCount, 3);
        defaultPos = array.getInteger(R.styleable.cl_LevelLayout_cl_defaultPos, 0);
        scrollDuration = array.getInteger(R.styleable.cl_LevelLayout_cl_scrollDuration, 400);
        lineHeight = array.getDimension(R.styleable.cl_LevelLayout_cl_lineHeight, 6);
        lineColor = array.getColor(R.styleable.cl_LevelLayout_cl_lineColor, Color.parseColor("#eeeeee"));
        pointRadius = array.getDimension(R.styleable.cl_LevelLayout_cl_pointRadius, 15);
        pointColor = array.getColor(R.styleable.cl_LevelLayout_cl_pointColor, Color.parseColor("#eeeeee"));
        array.recycle();
    }

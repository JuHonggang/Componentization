...
public class CommonChooseDialog extends AlertDialog {
    ...
    public CommonChooseDialog(Context context, List<String> itemList, String title) {
        super(context, R.style.cl_CommonDialog);
        if (itemList != null) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cl_dialog_common_choose_layout);
        ...
        if (!TextUtils.isEmpty(title)) {
            ...
            titleText.setTextColor(getContext().getResources().getColor(R.color.cl_b2));
        ...
        if (items != null && items.length > 0) {
            textSize = 18;
            textColor = getContext().getResources().getColor(R.color.cl_b1);
    ...
    public void show() {
        ...
        window.setWindowAnimations(R.style.cl_BottomDialogTheme);

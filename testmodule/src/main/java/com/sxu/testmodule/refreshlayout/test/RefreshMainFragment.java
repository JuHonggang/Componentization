...
import com.sxu.testmodule.refreshlayout.test.GridFragment;
import com.sxu.testmodule.refreshlayout.test.TextFragment;
	...
	public void onClick(View v) {
		switch (v.getId()) {
			case R.id.list_button:
				addFragment(new com.sxu.testmodule.refreshlayout.test.ListFragment());
				break;
